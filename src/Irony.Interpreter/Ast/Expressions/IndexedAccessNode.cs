    ...
    public class IndexedAccessNode : AstNode
    {
        ...
        protected override object DoEvaluate(ScriptThread thread)
        {
            ...
            else
            {
                ...
                result = type.GetMethod("get_Item", flags).Invoke(targetValue, new object[] { indexValue });
#else
...
#if DNXCORE50
                const BindingFlags flags = BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase;
                type.GetMethod("set_Item", flags).Invoke(targetValue, new object[] { indexValue, value });
#else
                const BindingFlags flags = BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase | BindingFlags.InvokeMethod;
