...
namespace Irony.Parsing
{
    ...
    public class IdentifierTerminal : CompoundTerminalBase
    {
        ...
        public TokenEditorInfo KeywordEditorInfo = new TokenEditorInfo(TokenType.Keyword, TokenColor.Keyword,
            TokenTriggers.None);
 ...
 */
        ...
        protected override bool ReadBody(ISourceStream source, CompoundTokenDetails details)
        {
            ...
            while (!source.EOF())
            {
                ...
                var currCat = CharUnicodeInfo.GetUnicodeCategory(current);
        ...
        private bool CharOk(char ch, bool first)
        {
            ...
            {
                var chCat = CharUnicodeInfo.GetUnicodeCategory(ch);
