...
//in case any of them is null
        ...
        private class StringSubTypeList : List<StringSubType>
        {
            ...
            {
                base.Add(new StringSubType(start, end, flags, (byte) Count));
            }
        }
        ...
        public override void Init(GrammarData grammarData)
        {
            ...
            foreach (var subType in _subtypes)
            {
                if (allStartSymbols.Contains(subType.Start))
                    grammarData.Language.Errors.Add(GrammarErrorLevel.Error, null,
                        Resources.ErrDupStartSymbolStr, subType.Start, Name);
            ...
            if (isTemplate)
            {
                ...
                if (templateSettings == null)
                    ...
                    grammarData.Language.Errors.Add(GrammarErrorLevel.Error, null, Resources.ErrTemplMissingExprRoot,
                        Name); //""
        ...
        public override IList<string> GetFirsts()
        {
            ...
            foreach (var ch in _startSymbolsFirsts)
