...
namespace Irony.Tests
{
    public class NumberLiteralTests
    {
        ...
        public void TestNumber_SignedMatchesNegativeCorrectly()
        {
            ...
            Assert.True(-500 == (int)token.Value, $"Negative number was parsed incorrectly; expected: {"-500"}, scanned: {token.Value}");
        }
        ...
        {
            Assert.True(token != null, "TryMatch returned null, while token was expected.");
